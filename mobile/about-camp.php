...
<head>
    <title>About The Camp | Camp Noel Resorts Munnar</title>
<meta name="Description" content="Camp Noel Resorts offers luxury camps in Munnar , Kerala India. Here you can enjoy luxury Camps and feel the spirit of nature where you will cherish the experience for life."/>
<meta name="Keywords" content="tent camping in Munnar, best Munnar camping, Munnar tent camping"/>
...
<div data-role="page">
    <div data-role="header" data-id="homepage" data-theme="c" class="five-panel-menu">
        ...
        <div id="featuredImage">
            <img src='../home/img/gallery/camp-view2.jpg' alt="Camp Noel Munnar - About Camp" onerror="imageError(this)" style="width:100%"/>
        </div>
        <nav>
    ...
    <div data-role="content" class="outer-container" style="position: relative">
        <div class="opacity-overlay container">
            <div class="inner-content article-content">
                <div class="artMainCon"><h1 class='section Header grid-align-left'>About The Camp</h1>
                    <div class='section btq-grid-row' data-subtype='1'>
                    <ul>
                        <li><strong>Altitude</strong>
                          --   Camp Noel is 6550 feet above sea level.</li>
                        <li><strong>Temperature</strong>
                          --   The average temperature is 15 to 20 C<br>
                        (Summer:15C - 28C, Winter:0C-15C).</li>
                        <li><strong>Suggested attire</strong>
                          --   Warm clothes and a jacket or sweater.</li>
                        <li><strong>Security</strong>
                          --   Gated compound with round the clock security.
                        </li>
                        <li><strong>Transportation</strong>
                          --   Transportation to and from Munnar town or Cochin can be arranged on request.</li>
                        <li><strong>Monsoon</strong>
                          --   June, July, August.</li>
                        ...
                        <li><strong>Languages</strong>
                          --   Malayalam, Tamil &amp; English.</li>
                        <li><strong>Medical Facility</strong>
                          --   Nearest clinic is 4 kms away at the Tata Chithuvarai estate.<br>
                        Munnar General Hospital is 36 kms away.</li>
                    </ul>

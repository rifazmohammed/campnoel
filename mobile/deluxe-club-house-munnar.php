...
<link rel="canonical" href="http://www.campnoel.com/deluxe-club-house-munnar.php"/>
    ...
    <link type="text/css" rel="stylesheet" href="css/jquery-comfort.css">
...
<div data-role="page">
    <div data-role="header" data-id="homepage" data-theme="c" class="five-panel-menu">
        ...
        <div id="featuredImage">
            <img src='../home/img/room-type-1.jpg' alt="Camp Noel Munnar - Deluxe Club House" onerror="imageError(this)" style="width:100%"/>
        </div>
        <nav>
    ...
    <div data-role="content" class="outer-container" style="position: relative">
        <div class="opacity-overlay container">
            <div class="inner-content article-content">
                <div class="artMainCon"><h1 class='section Header grid-align-left'>Deluxe Club House</h1>
                    <div class='section btq-grid-row' data-subtype='1'>
                        <div class='txt btq-grid__col--full'>
                         ...
                         <div class="roomcat roomovewviewinfo">
                                            <h2>Facilities</h2>
                                                <ul>
                                                    <li>Free WiFi (In Lobby)</li>
                                                    <li>Meeting or Party</li>
                                                    <li>Transportation(On Demand)</li>
                                                    <li>Laundry Service</li>
                                                    <li>Telephone Service</li>
                                                    <li>Sightseeing Guide</li>
                                                    <li>Comfy Bed</li>
                                                    <li>Camp Fire (On Demand)</li>
                                                </ul>
                                </div>
                        </div>
...
<script type="text/javascript">
    ...
    var CurrentPageName = "articledetail";
</script>
